...
namespace ConsoleAppArrayAssignment
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            // Ask for number to display the string at that index
            ...
            { 
                ...
                {
                    Console.WriteLine("Sorry, that number selection is invalis. Please select a number between 0 and 9. ");
            ...
            // Ask user to a number to display the string at that Index
            ...
            while (!validList)
            {
                try
                { 
                    Console.WriteLine("Your occupation is: " + occupationList[listSelect]);
                    validList = true;
                    Console.ReadLine();
                }
                // Add a message to display if the user picks an index that doesn't exist
